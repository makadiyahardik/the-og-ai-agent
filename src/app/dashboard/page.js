              ...
              {userMenuOpen && (
                <div className="absolute right-0 top-full mt-2 w-64 bg-[#2f2f2f] rounded-xl border border-gray-700 shadow-xl overflow-hidden animate-fade-in z-50">
                  ...
                  <div className="p-1">
                    <Link
                      href="/pricing"
                      className="w-full flex items-center gap-3 px-3 py-2.5 text-gray-300 hover:bg-gray-700/50 rounded-lg transition-colors text-left"
                    >
                      <Icons.Sparkles />
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <textarea
                ...
                placeholder={mode === 'image' ? 'Describe the image you want to create...' : 'Message AI Assistant...'}
